...
@JsonDeserialize(builder = TripUpdateRequest.Builder.class)
class TripUpdateRequest {
  ...
  TripUpdateRequest(Builder builder) {
  ...
  static class Builder {
    ...
    public TripUpdateRequest build() {
      return new TripUpdateRequest(this);
    }
  }

  static TripUpdateRequest.Builder builder() {
    return new TripUpdateRequest.Builder();
  }
}
