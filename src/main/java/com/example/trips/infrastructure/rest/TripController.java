...
class TripController {
  ...
  public ResponseEntity<TripResponse> create(@RequestBody TripCreateRequest tripCreateRequest) {
    TripCreateDto tripCreateDto = new TripCreateDto(
        tripCreateRequest.getStartDestinationCoordinates(),
        tripCreateRequest.getFinalDestinationCoordinates(), tripCreateRequest.getOwnerEmail(),
        tripCreateRequest.getStartTime(), tripCreateRequest.getEndTime());
