package com.example.trips.reader.rest;

import com.example.trips.configuration.exception.InternalServerErrorException;
import com.example.trips.configuration.exception.NotFoundException;
import com.example.trips.configuration.exception.ValidationException;
...
import com.example.trips.reader.api.service.TripMessageProcessorAggregator;
import com.example.trips.reader.api.service.TripService;
import com.example.trips.configuration.properties.AuthenticationProperties;
import com.example.trips.reader.RabbitFinishTripMessageProcessor;
import com.example.trips.reader.RabbitStartTripMessageProcessor;
import com.example.trips.reader.infrastructure.rest.TripController;
